...
The primary discussion relevant to this paper is in the comparison of the four structures: Section~\ref{subsec:space compare} and Section~\ref{subsec:timecompare}.
...
\begin{figure}[ht]
\centering
\subfigure[\textsc{Slow-Query} with $t = ??$, $p = ??$, $k ??$]{%
\fbox{\includegraphics[width = 3in]{figures/plot-slowquery-space.pdf}}
\label{fig:space1}}
\quad
\subfigure[\textsc{Big-Space} with $t= ??$, $p = ??$, $k ??$]{%
\fbox{\includegraphics[width = 3in]{figures/plot-bigspace-space.pdf}}
\label{fig:space2}}
\subfigure[\textsc{CPD-Slow} with $t = ??$, $p = ??$, $k ??$]{%
\fbox{\includegraphics[width = 3in]{figures/plot-cpdslow-space.pdf}}
\label{fig:space3}}
\quad
\subfigure[\textsc{CPD-Fast} with $t = ??$, $p = ??$, $k ??$]{%
\fbox{\includegraphics[width = 3in]{figures/plot-cpdfast-space.pdf}}
\label{fig:space4}}
%
\caption{The figures above show the space usage of each of the different solutions for varying values of $t$ and $k$.}
\label{fig:figure}
\end{figure}
